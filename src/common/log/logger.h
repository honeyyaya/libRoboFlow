#ifndef __RFLOW_COMMON_LOG_LOGGER_H__
#define __RFLOW_COMMON_LOG_LOGGER_H__
...
inline rflow_err_t logger_configure_level(rflow_log_level_t level) {
    logger_set_level(level);
    return RFLOW_OK;
}

inline rflow_err_t logger_configure_callback(librflow_log_cb_fn cb, void* ud) {
    logger_set_callback(cb, ud);
    return RFLOW_OK;
}
...
#endif  // __RFLOW_COMMON_LOG_LOGGER_H__
