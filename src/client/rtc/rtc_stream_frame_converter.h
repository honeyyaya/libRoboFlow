...
#ifndef __RFLOW_CLIENT_RTC_RTC_STREAM_FRAME_CONVERTER_H__
#define __RFLOW_CLIENT_RTC_RTC_STREAM_FRAME_CONVERTER_H__
...
#endif  // __RFLOW_CLIENT_RTC_RTC_STREAM_FRAME_CONVERTER_H__
