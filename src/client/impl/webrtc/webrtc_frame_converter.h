/**
 * @file   webrtc_frame_converter.h
 * @brief  webrtc::VideoFrame → librflow_video_frame_s（I420 连续布局）
 *
 * 说明：
...
#ifndef __RFLOW_CLIENT_IMPL_WEBRTC_FRAME_CONVERTER_H__
#define __RFLOW_CLIENT_IMPL_WEBRTC_FRAME_CONVERTER_H__
...
#endif  // __RFLOW_CLIENT_IMPL_WEBRTC_FRAME_CONVERTER_H__
