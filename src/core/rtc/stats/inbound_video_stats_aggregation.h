#ifndef __RFLOW_CORE_RTC_STATS_INBOUND_VIDEO_STATS_AGGREGATION_H__
#define __RFLOW_CORE_RTC_STATS_INBOUND_VIDEO_STATS_AGGREGATION_H__
...
#endif  // __RFLOW_CORE_RTC_STATS_INBOUND_VIDEO_STATS_AGGREGATION_H__
