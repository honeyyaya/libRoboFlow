...
#  pragma GCC diagnostic pop
    ...
    if (deps.video_encoder_factory == nullptr) {
        ...
        deps.video_encoder_factory = rflow::rtc::adapt::CreatePreferredVideoEncoderFactory(prefs);
    }
    if (deps.video_decoder_factory == nullptr) {
        ...
        deps.video_decoder_factory = rflow::rtc::adapt::CreatePreferredVideoDecoderFactory(prefs);
    }
