#ifndef __RFLOW_SERVICE_IMPL_MEDIA_PUSH_CAMERA_VIDEO_TRACK_SOURCE_H__
#define __RFLOW_SERVICE_IMPL_MEDIA_PUSH_CAMERA_VIDEO_TRACK_SOURCE_H__
...
class CameraVideoTrackSource : public LocalAdaptedVideoTrackSource,
...
private:
    ...
    std::shared_ptr<rflow::hw::capture::IMjpegHwCapture> mjpeg_mpp_;
#endif
#endif
...
#endif  // __RFLOW_SERVICE_IMPL_MEDIA_PUSH_CAMERA_VIDEO_TRACK_SOURCE_H__
